function Get-AzDevOpsReleaseDefinitionList
{
    <#
    .SYNOPSIS
    Returns a list of Azure DevOps release definitions.
    
    .DESCRIPTION
    Returns a list of Azure DevOps release definitions based on a filter query.
    ...
    .OUTPUTS
    PSObject, Azure DevOps release definition(s)
    
    .EXAMPLE
    Returns release definition list for 'myFirstProject'.
    Get-AzDevOpsReleaseDefinitionList -Instance 'https://dev.azure.com' -Collection 'myCollection' -Project 'myFirstProject'
    ...
    process
    {
        $apiEndpoint = Get-AzDevOpsApiEndpoint -ApiType 'release-definitions'
        ...
        If ($results.continuationToken -and (-not($PSBoundParameters.ContainsKey('Top'))))
        {
            ...
            Get-AzDevOpsReleaseDefinitionList @PSBoundParameters -ContinuationToken $results.continuationToken
        }
