function Get-AzDevOpsBuildDefinitionList
{
    ...
    Get-AzDevOpsBuildDefinitionList -Instance 'https://dev.azure.com' -Collection 'myCollection' -Project 'myFirstProject'
    ...
    process
    {
        $apiEndpoint = Get-AzDevOpsApiEndpoint -ApiType 'build-definitions'
        ...
        If ($results.continuationToken -and (-not($PSBoundParameters.ContainsKey('Top'))))
        {
            ...
            Get-AzDevOpsBuildDefinitionList @PSBoundParameters -ContinuationToken $results.continuationToken
        }
