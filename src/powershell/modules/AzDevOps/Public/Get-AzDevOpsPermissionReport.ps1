function Get-AzDevOpsPermissionReport
{
    <#
    .SYNOPSIS
    ...
    The report id can be returned by Get-AzDevOpsPermissionReportList.
    ...
    .EXAMPLE
    Returns permission report for 'myCollection' with the id of '7'.
    Get-AzDevOpsPermissionReportList -Instance 'https://dev.azure.com' -Collection 'myCollection' -ReportId '7'
    ...
    process
    {
        $apiEndpoint = (Get-AzDevOpsApiEndpoint -ApiType 'permissions-reportId') -f $ReportId
