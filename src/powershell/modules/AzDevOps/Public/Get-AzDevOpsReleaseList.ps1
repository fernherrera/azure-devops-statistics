function Get-AzDevOpsReleaseList
{
    <#
    .SYNOPSIS
    Returns a list of Azure DevOps releases.
    
    .DESCRIPTION
    Returns a list of Azure DevOps releases based on a filter query.
    ...
    .OUTPUTS
    PSObject, Azure DevOps release(s)

    .EXAMPLE
    Returns AP release list for 'myFirstProject'.
    Get-AzDevOpsReleaseList -Instance 'https://dev.azure.com' -Collection 'myCollection' -Project 'myFirstProject'
    ...
    process
    {
        $apiEndpoint = Get-AzDevOpsApiEndpoint -ApiType 'release-releases'
        ...
        If ($results.continuationToken -and (-not($PSBoundParameters.ContainsKey('Top'))))
        {
            ...
            Get-AzDevOpsReleaseList @PSBoundParameters -ContinuationToken $results.continuationToken
        }
