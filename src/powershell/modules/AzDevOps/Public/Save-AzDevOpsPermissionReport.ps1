function Save-AzDevOpsPermissionReport
{
    <#
    .SYNOPSIS
    ...
    Save-AzDevOpsPermissionReportList -Instance 'https://dev.azure.com' -Collection 'myCollection' -ReportId '7' -OutputPath 'C:\temp\myReport.json'
    ...
    process
    {
        $apiEndpoint = (Get-AzDevOpsApiEndpoint -ApiType 'permissions-download') -f $ReportId
