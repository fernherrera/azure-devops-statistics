function Invoke-AzDevOpsWebRequest
{
    <#
    .SYNOPSIS
    Invokes an Azure DevOps web method.
    ...
    .EXAMPLE
    Invokes rest method 'PATCH' against the uri 'https://dev.azure.com/release/releases?api-version=5.0-preview.6'.
    Invoke-AzDevOpsWebRequest -Method PATCH -Body $Body -ContentType 'application/json' -Uri 'https://dev.azure.com/release/releases?api-version=5.0-preview.6'
    ...
    process
    {
        ...
        $authenticatedRestMethodSplat = Set-AzDevOpsAuthenticationType -InputObject $invokeRestMethodSplat -Credential $Credential -PersonalAccessToken $PersonalAccessToken
