function Get-AzDevOpsDescriptor
{
    <#
    .SYNOPSIS
    ...
    Get-AzDevOpsDescriptor -Instance 'https://dev.azure.com' -Collection 'myCollection' -ApiVersion 5.0-preview -StorageKey '16c8b591-362d-4d7f-b77b-b04c2f110c52'
    ...
    process
    {
        $apiEndpoint = (Get-AzDevOpsApiEndpoint -ApiType 'graph-descriptorStorageKey') -f $StorageKey
