function Get-AzDevOpsUserEntitlementList
{
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    Returns user list for 'myCollection'.
    Get-AzDevOpsUserEntitlementList -Instance 'https://dev.azure.com' -Collection 'myCollection' -ApiVersion 6.1-preview
    ...
    process
    {
        $apiEndpoint = Get-AzDevOpsApiEndpoint -ApiType 'userentitlements-entitlements'
        ...
        If ($results.value.continuationToken)
        {
            ...
            Get-AzDevOpsUserEntitlementList @PSBoundParameters -ContinuationToken $continuationToken
        }
