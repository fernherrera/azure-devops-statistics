function Get-AzDevOpsUserList
{
    <#
    .SYNOPSIS
    Returns a list of Azure DevOps users.
    ...
    Get-AzDevOpsUserList -Instance 'https://dev.azure.com' -Collection 'myCollection' -ApiVersion 5.0-preview
    ...
    process
    {
        $apiEndpoint = Get-AzDevOpsApiEndpoint -ApiType 'graph-users'
        ...
        If ($results.continuationToken)
        {
            ...
            Get-AzDevOpsUserList @PSBoundParameters -ContinuationToken $results.continuationToken
        }
