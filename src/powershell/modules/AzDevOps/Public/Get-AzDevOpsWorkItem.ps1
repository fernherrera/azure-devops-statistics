function Get-AzDevOpsWorkItem
{
    ...
    The id can be retrieved by using Get-AzDevOpsWorkItemList.
    ...
    Get-AzDevOpsWorkItem -Instance 'https://dev.azure.com' -Collection 'myCollection' -Project 'myFirstProject' -WorkItemId 7
    ...
    process
    {
        $apiEndpoint = (Get-AzDevOpsApiEndpoint -ApiType 'wit-workitemId') -f $WorkItemId
