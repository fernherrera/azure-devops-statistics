function Get-AzDevOpsGitPullRequestList
{
    <#
    .SYNOPSIS
    ...
    Get-AzDevOpsGitPullRequestList -Instance 'https://dev.azure.com' -Collection 'myCollection' -Project 'myFirstProject' -RepositoryId 'e0eb12ee-83f2-4446-ac51-d067949e3a78'
    ...
    process
    {
        $apiEndpoint = Get-AzDevOpsApiEndpoint -ApiType 'git-pullRequests'
